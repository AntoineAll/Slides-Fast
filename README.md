...
- **Vue d'ensemble** ("slide sorter") : toutes les slides en miniature dans une grille, réorganisables par glisser-déposer, entièrement utilisable au clavier (`Tab`, flèches, `Entrée` pour ouvrir) comme à la souris (double-clic).
