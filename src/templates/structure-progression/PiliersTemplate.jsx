  ...
  return (
    <div className="w-[850px] h-[478px] bg-slate-950 rounded-2xl border-2 border-slate-800 shadow-2xl relative overflow-hidden flex-shrink-0 box-border">
      ...
      <div className="relative z-10 h-full w-full flex flex-col p-10 justify-between">
        {/* Titre de la slide */}
        <h3 className="text-4xl font-extrabold text-[var(--accent-title)] text-left tracking-tight">
        ...
        <div className="flex gap-6 items-stretch h-[280px]">
          {pillars.map((pillar, i) => (
            ...
            >
              {/* Icône / Emoji */}
              <div className="w-16 h-16 bg-[var(--accent-primary)]/20 text-3xl flex items-center justify-center rounded-2xl mb-4 border border-[var(--accent-primary)]/30 flex-shrink-0">
                {pillar.icone || '📍'}
              </div>
